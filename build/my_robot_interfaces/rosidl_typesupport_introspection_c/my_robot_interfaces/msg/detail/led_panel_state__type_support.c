...
bool my_robot_interfaces__msg__LedPanelState__rosidl_typesupport_introspection_c__resize_function__LedPanelState__led_status(
...
static rosidl_typesupport_introspection_c__MessageMember my_robot_interfaces__msg__LedPanelState__rosidl_typesupport_introspection_c__LedPanelState_message_member_array[1] = {
  {
    ...
    my_robot_interfaces__msg__LedPanelState__rosidl_typesupport_introspection_c__resize_function__LedPanelState__led_status  // resize(index) function pointer
  }
};
