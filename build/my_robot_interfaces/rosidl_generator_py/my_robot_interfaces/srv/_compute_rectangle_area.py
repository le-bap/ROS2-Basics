...
class ComputeRectangleArea_Request(metaclass=Metaclass_ComputeRectangleArea_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.widht = kwargs.get('widht', float())
    ...
    def widht(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'widht' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'widht' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._widht = value
