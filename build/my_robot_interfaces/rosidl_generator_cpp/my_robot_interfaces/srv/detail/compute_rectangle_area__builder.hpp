...
class Init_ComputeRectangleArea_Request_widht
{
public:
  explicit Init_ComputeRectangleArea_Request_widht(::my_robot_interfaces::srv::ComputeRectangleArea_Request & msg)
  : msg_(msg)
  {}
  ::my_robot_interfaces::srv::ComputeRectangleArea_Request widht(::my_robot_interfaces::srv::ComputeRectangleArea_Request::_widht_type arg)
  {
    msg_.widht = std::move(arg);
...
public:
  ...
  {}
  Init_ComputeRectangleArea_Request_widht length(::my_robot_interfaces::srv::ComputeRectangleArea_Request::_length_type arg)
  {
    msg_.length = std::move(arg);
    return Init_ComputeRectangleArea_Request_widht(msg_);
  }
