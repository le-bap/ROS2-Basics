...
class Init_SetLed_Response_led_on
{
public:
  Init_SetLed_Response_led_on()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::my_robot_interfaces::srv::SetLed_Response led_on(::my_robot_interfaces::srv::SetLed_Response::_led_on_type arg)
  {
...
{
  return my_robot_interfaces::srv::builder::Init_SetLed_Response_led_on();
}
