...
class Init_LedPanelState_led_status
{
public:
  Init_LedPanelState_led_status()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::my_robot_interfaces::msg::LedPanelState led_status(::my_robot_interfaces::msg::LedPanelState::_led_status_type arg)
  {
...
{
  return my_robot_interfaces::msg::builder::Init_LedPanelState_led_status();
}
