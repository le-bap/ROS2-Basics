...
void resize_function__LedPanelState__led_status(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int64_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LedPanelState_message_member_array[1] = {
  {
    ...
    resize_function__LedPanelState__led_status  // resize(index) function pointer
  }
};
